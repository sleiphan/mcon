...
/// existing connections without establishing new ones. The shutdown is complete when all
/// connections managed by this instance are closed.
/// @param mcon The mcon instance to shut down.
/// @return When successful, returns 0. When an error occurs, returns -1 and errno is set to
/// indicate the error.
