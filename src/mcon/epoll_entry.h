...
#define MCON_EPOLL_ENTRY_GENERATION_SHIFT                                                          \
    (MCON_EPOLL_ENTRY_INSTANCE_SHIFT - MCON_EPOLL_ENTRY_GENERATION_SIZE)
#define MCON_EPOLL_ENTRY_SOURCE_SHIFT                                                              \
    (MCON_EPOLL_ENTRY_GENERATION_SHIFT - MCON_EPOLL_ENTRY_SOURCE_SIZE)
#define MCON_EPOLL_ENTRY_SESSION_SHIFT                                                             \
    (MCON_EPOLL_ENTRY_SOURCE_SHIFT - MCON_EPOLL_ENTRY_SESSION_SIZE)
...
static inline struct mcon_epoll_entry mcon_decode_epoll_entry(const epoll_data_t data) {
    return (struct mcon_epoll_entry){
        .instance_id =
            (data.u64 >> MCON_EPOLL_ENTRY_INSTANCE_SHIFT) & MCON_EPOLL_ENTRY_INSTANCE_MASK,
        .generation =
            (data.u64 >> MCON_EPOLL_ENTRY_GENERATION_SHIFT) & MCON_EPOLL_ENTRY_GENERATION_MASK,
